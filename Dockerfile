...
RUN go get -u github.com/lib/pq  golang.org/x/crypto/bcrypt  github.com/justinas/alice github.com/swaggo/http-swagger/v2 github.com/golang-jwt/jwt/v5 golang.org/x/tools  golang.org/x/sys
